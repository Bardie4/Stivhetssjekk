...
protected:
  ...
  virtual bool next_1(bool loop = false) = 0;
  ...
  virtual bool prev_1(bool loop = false) = 0;
...
public:
  ...
  //! @param id ID for debugging purposes
...
public:
  ...
  bool next_1(bool loop = false);
  bool prev_1(bool loop = false);
  void reset();
