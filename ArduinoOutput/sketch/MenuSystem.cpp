...
bool MenuItem::next_1(bool loop)
{
    return false;
}
...
bool MenuItem::prev_1(bool loop)
{
    return false;
}
...
NumericMenuItem::NumericMenuItem(const char *basename, SelectFnPtr select_fn,
                                 char id, float value, float min_value, float max_value,
                                 float increment,
...
char NumericMenuItem::get_id() const
{
    return _id;
}
...
bool NumericMenuItem::next_1(bool loop)
{
    _value += 0.01;
    if (_value > _max_value)
    {
...
bool NumericMenuItem::prev_1(bool loop)
{
    _value -= 0.01;
    if (_value < _min_value)
    {
...
bool MenuSystem::next_1(bool loop)
{
    if (_p_curr_menu->_p_current_component->has_focus())
        return _p_curr_menu->_p_current_component->next_1(loop);
    else
        return _p_curr_menu->next_1(loop);
}

bool MenuSystem::prev_1(bool loop)
{
    if (_p_curr_menu->_p_current_component->has_focus())
        return _p_curr_menu->_p_current_component->prev_1(loop);
    else
        return _p_curr_menu->prev_1(loop);
}
